...
/** Flat list of key configuration fields to display in the "执行摘要" panel section. */
...
/**
 * Extracts the most important configuration fields for a node into a flat summary.
