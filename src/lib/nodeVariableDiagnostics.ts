...
export type NodeVariableIssue = {
  /** Upstream node that already defined this variable, for override warnings. */
...
/** Input issues flag undefined/malformed variable refs; output issues warn on overwriting an upstream node's variable. */
