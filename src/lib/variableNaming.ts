...
export type VariableNameValidation = {
  /** Cleaned-up form of the input, shown as a hint when the raw value would be rejected. */
...
/** `reference` mode warns on unknown names; `target` mode warns when the name already exists (will overwrite). */
