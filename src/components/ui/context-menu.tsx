...
const ContextMenuSubContent = forwardRef<ElementRef<typeof ContextMenuPrimitive.SubContent>, ComponentPropsWithoutRef<typeof ContextMenuPrimitive.SubContent>>(
  ({ className, ...props }, ref): ReactElement => (
    <ContextMenuPrimitive.SubContent
      className={cn('z-50 min-w-[8rem] overflow-hidden rounded-md border border-slate-200 bg-white p-1 text-slate-700 shadow-lg', className)}
      ref={ref}
      {...props}
    />
  )
  ...
  ({ className, ...props }, ref): ReactElement => (
    <ContextMenuPrimitive.Portal>
      <ContextMenuPrimitive.Content
        className={cn('z-50 min-w-[8rem] overflow-hidden rounded-lg border border-slate-200 bg-white p-1.5 text-slate-700 shadow-lg', className)}
        ref={ref}
        {...props}
      />
    </ContextMenuPrimitive.Portal>
