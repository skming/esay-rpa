...
export function Input({ className, tone = 'default', type = 'text', ...props }: InputProps): ReactElement {
  return (
    <input
      className={cn(
        'flex h-8 w-full rounded-md border border-slate-200 bg-white px-2 text-[11px] text-slate-700 outline-none transition placeholder:text-slate-500 focus-visible:border-accent-line focus-visible:ring-2 focus-visible:ring-accent-soft disabled:cursor-not-allowed disabled:opacity-50',
