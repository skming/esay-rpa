    ...
    >
      ...
      >
        ...
        <div className="px-2.5 pt-2.5 pb-1.5">
          <Label
            className={cn(
              'flex h-7 items-center gap-2 rounded-lg border px-2.5 text-slate-400 transition-all duration-150',
          ...
          >
            ...
            <Input
              className="h-auto min-w-0 flex-1 rounded-none border-0 bg-transparent px-0 text-[11px] text-slate-700 placeholder:text-slate-400 focus:ring-0 focus:outline-hidden"
      ...
      <div
        className={cn(
          'flex h-9 shrink-0 items-center border-t border-slate-100 px-3 text-[10px] text-slate-400',
          'transition-opacity duration-150',
          collapsed ? 'pointer-events-none opacity-0' : 'opacity-100',
        )}
      >
