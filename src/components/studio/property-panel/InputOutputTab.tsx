...
function EmptyRow({ text }: { text: string }): ReactElement {
  return <div className="rounded-md border border-dashed border-slate-200 bg-slate-50 px-2 py-1.5 text-[11px] leading-4 text-slate-500">{text}</div>;
}
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <span className="max-w-22.5 truncate font-mono text-[10px] text-slate-500">{description}</span>
      </div>
