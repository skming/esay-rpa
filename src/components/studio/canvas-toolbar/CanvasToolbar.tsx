...
// Breakpoints (toolbar's own pixel width, not viewport)
// >= 740 → stats + progress both visible
// >= 560 → stats only, progress hidden
//  < 560 → both hidden, only core tools shown
