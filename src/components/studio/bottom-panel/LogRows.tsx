          ...
          {rows.map((row) => {
            ...
            return (
              <TableRow
                ...
                key={row.id}
              >
                <TableCell className="w-24 py-1 pl-2 font-mono text-[11px] tabular-nums text-slate-400">
                  {row.time}
                </TableCell>
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <span className="min-w-0 cursor-default truncate block">
                        {row.message}
                        {row.detail !== undefined && <span className="ml-2 text-slate-400">{row.detail}</span>}
                      </span>
                    </TooltipTrigger>
                ...
                <TableCell className="w-30 py-1">
                  {canJump ? (
                    ...
                    <span className="text-[10px] text-slate-400">未绑定节点</span>
                  )}
                </TableCell>
