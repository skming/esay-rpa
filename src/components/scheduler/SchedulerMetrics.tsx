...
import { Figure, StatBand } from '../workspace/ledger';
  ...
  return (
    <StatBand>
      ...
      <Figure
        label="最近触发"
        value={
          <span className="figure text-[18px] text-ink-2">
            {latestNextRun === undefined ? '未计算' : formatScheduleDateTime(latestNextRun.nextRunAt)}
          </span>
        }
        note="下次"
      />
