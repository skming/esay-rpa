...
export const kindStyles: Record<NodeKind, KindStyle> = {
  /* Azure — browser (web blue; deliberately NOT the indigo accent, which is
     reserved for live/running status so state reads as the only indigo on the canvas) */
  browser: {
    accent: '#2563eb',
    bg: '#eff6ff',
    border: '#dbeafe',
  ...
  /* Gold — variable / message (warm utility; off the indigo it used to share
     with browser, so the canvas no longer reads as a wall of indigo) */
  variable: {
    accent: '#4f46e5',
    bg: '#eef2ff',
    border: '#dbeafe',
