        ...
        <div className="flex min-w-0 flex-1 flex-col overflow-hidden">
          {!backendReady ? (
            <BackendBootScreen
              ...
              installingBrowser={backendStatus?.status === 'installing-browser'}
              installProgress={backendStatus?.installProgress ?? null}
              installStep={backendStatus?.installStep ?? null}
              installStepLabel={backendStatus?.installStepLabel ?? null}
              installStepTotal={backendStatus?.installStepTotal ?? null}
