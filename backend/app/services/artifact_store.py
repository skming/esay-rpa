...
def _safe_id(value: str) -> str:
    """Return a filesystem-safe, path-traversal-free version of *value* (for IDs)."""
...
class ArtifactStore(Protocol):
    """Common interface for artifact backends (local / MinIO)."""
...
class MinioClientProtocol(Protocol):
    """Subset of the MinIO client API consumed by MinioArtifactStore."""
